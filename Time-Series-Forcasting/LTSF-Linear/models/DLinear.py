...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.individual:
            ...
            if self.version == 'D':
                self.Seasonal_Linear1 = nn.Linear(self.seq_len, self.seq_len)
                self.Trend_Linear1 = nn.Linear(self.seq_len, self.seq_len)
                self.Seasonal_Linear2 = nn.Linear(self.seq_len, self.pred_len)
                self.Trend_Linear2 = nn.Linear(self.seq_len, self.pred_len)
